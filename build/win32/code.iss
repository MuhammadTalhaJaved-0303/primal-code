...
AppPublisher=Primal AI
AppCopyright=Copyright (C) 2026 Primal AI. Portions Copyright (C) Microsoft Corporation.
AppPublisherURL=https://github.com/MuhammadTalhaJaved-0303/primal-code
AppSupportURL=https://github.com/MuhammadTalhaJaved-0303/primal-code/issues
AppUpdatesURL=https://github.com/MuhammadTalhaJaved-0303/primal-code/releases
DefaultGroupName={#NameLong}
AllowNoIcons=yes
OutputDir={#OutputDir}
OutputBaseFilename=PrimalCodeSetup
Compression=lzma
...
begin
  Result := True;
    ...
    if not WizardSilent() and IsAdmin() then begin
      if MsgBox('This User Installer is not meant to be run as an Administrator. If you would like to install Primal Code for all users in this system, download the System Installer instead from https://github.com/MuhammadTalhaJaved-0303/primal-code/releases. Are you sure you want to continue?', mbError, MB_OKCANCEL) = IDCANCEL then begin
        Result := False;
      end;
    end;
  #endif

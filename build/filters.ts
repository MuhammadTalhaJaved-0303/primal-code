...
export const unicodeFilter = Object.freeze<string[]>([
	...
	'!**/*.{dll,exe,png,bmp,jpg,gif,scpt,cur,ttf,woff,woff2,eot,template,ico,icns,opus,wasm}',
	'!**/test/**',
	'!**/*.test.ts',
	'!**/*.{d.ts,json,md}',
	'!**/*.mp3',
...
export const indentationFilter = Object.freeze<string[]>([
	...
	'!src/typings/**/*.d.ts',
	'!extensions/**/*.d.ts',
	'!**/*.{svg,exe,png,bmp,jpg,gif,scpt,bat,cmd,cur,ttf,woff,woff2,eot,md,ps1,psm1,template,yaml,yml,d.ts.recipe,ico,icns,plist,opus,admx,adml,wasm}',

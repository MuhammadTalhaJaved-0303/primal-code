	...
	const schema: IJSONSchema = {
		...
		properties: {
			...
			'disable-chromium-sandbox': {
				type: 'boolean',
				description: localize('argv.disableChromiumSandbox', "Disables the Chromium sandbox. This is useful when running Primal Code as elevated on Linux and running under Applocker on Windows.")
			},

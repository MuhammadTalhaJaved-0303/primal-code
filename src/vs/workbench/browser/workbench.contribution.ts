...
(function registerConfiguration(): void {
	...
	registry.registerConfiguration({
		...
		'properties': {
			...
			[LayoutSettings.ACTIVITY_BAR_LOCATION]: {
				...
				'default': 'top', // Primal Code: no left icon rail — the Activity Bar rides on top of the side bars.
			...
			[LayoutSettings.LAYOUT_ACTIONS]: {
				'type': 'boolean',
				'default': false, // Primal Code: chrome restraint — layout control off by default (users can re-enable)
				'markdownDescription': isWeb ?
	...
	windowTitleDescription += '\n- ' + [
		...
		localize('appName', "`${appName}`: e.g. Primal Code."),

					...
					try {
						...
						if (!this._didReportIssue) {
							...
							this.dialogService.prompt({
								...
								message: localize('chatSessionStore.writeError', 'Error serializing chat session for storage. The session will be lost if the window is closed. Please report this issue to the Primal Code team:\n\n{0}', e.stack || toErrorMessage(e)),
								buttons: [

...
export class ClientToolSetsContribution extends Disposable implements IWorkbenchContribution {
	...
	constructor(
		...
		this._register(this._registerDynamicToolSet(toolsService, {
			...
			icon: Codicon.vscode,
			description: localize('clientToolSet.vscode.description', "Primal Code"),
			detail: localize('clientToolSet.vscode.detail', "Navigate code, manage extensions, and run built-in Primal Code commands."),
			members: [

...
const DEFAULT_CONTENT: string = [
	`// ${nls.localize('displayLanguage', 'Defines the keyboard layout used in Primal Code in the browser environment.')}`,
	`// ${nls.localize('doc', 'Open Primal Code and run "Developer: Inspect Key Mappings (JSON)" from Command Palette.')}`,
	``,

...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			metadata: {
				description: localize2('minWelcomeDescription', 'Opens a Walkthrough to help you get started in Primal Code.')
			}
		});
	}
	...
	properties: {
		...
		'workbench.startupEditor': {
			...
			'enumDescriptions': [
				...
				localize({ comment: ['This is the description for a setting. Values surrounded by single quotes are not to be translated.'], key: 'workbench.startupEditor.welcomePage' }, "Open the Welcome page, with content to aid in getting started with Primal Code and extensions."),
			...
			// Primal Code: the Primal Start page takes over the startup editor, so the
			// Getting Started page no longer opens on its own. It stays reachable through
			// `workbench.action.openWalkthrough` (Help: Welcome) and every walkthrough link,
			// and setting this back to 'welcomePage' restores the upstream behavior.
			'default': 'none',

...
configurationRegistry.registerConfiguration({
	...
	properties: {
			...
			policy: {
				...
				localization: {
					description: {
						...
						value: nls.localize('chat.agentHost.claudeAgent.enabled.policy', "Enable Claude Agent sessions in Primal Code. Start and resume agentic coding sessions powered by Anthropic Claude Agent SDK directly in the editor. Uses your existing Copilot subscription."),
					}
				}
			},
		},
		...
		[AgentHostCodexAgentEnabledSettingId]: {
			...
			// Primal Code ships Codex on: it is the harness for OpenAI keys.
			default: true,
			tags: ['experimental', 'advanced'],
			...
			policy: {
				...
				localization: {
					description: {
						...
						value: nls.localize('chat.agentHost.codexAgent.enabled.policy', "Enable Codex Agent sessions in Primal Code. Start and resume agentic coding sessions powered by OpenAI Codex. Usage can be routed through GitHub Copilot or authenticated directly with an OpenAI account."),
					}
				}
			},
		},

...
const terminalPlatformConfiguration: IConfigurationNode = {
	...
	properties: {
		...
		[TerminalSettingId.InheritEnv]: {
			...
			description: localize('terminal.integrated.inheritEnv', "Whether new shells should inherit their environment from Primal Code, which may source a login shell to ensure $PATH and other development variables are initialized. This has no effect on Windows."),
			type: 'boolean',
			default: true
		},

...
export class OpenVSCodeWindowAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('openVSCodeWindow', 'Open Primal Code Window'),
			f1: true,
			keybinding: {
...
export class ReturnToVSCodeEditorAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('returnToVSCodeEditor', 'Return to Primal Code Editor'),
		});
	}
...
export class ShouldShowReturnToVSCodeEditorAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: localize2('shouldShowReturnToVSCodeEditor', 'Check Whether to Show Return to Primal Code Editor'),
		});
	}
